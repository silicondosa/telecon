...
EVT_MENU(mpID_FIT, mainFrame::OnFit)
EVT_MENU(ID_ALIGN_X_AXIS, mainFrame::OnAlignXAxis)
EVT_MENU(ID_ALIGN_Y_AXIS, mainFrame::OnAlignYAxis)
EVT_MENU(ID_TOGGLE_GRID, mainFrame::OnToggleGrid)
EVT_MENU(ID_TOGGLE_SCROLLBARS, mainFrame::OnToggleScrollbars)
EVT_MENU(ID_TOGGLE_INFO, mainFrame::OnToggleInfoLayer)
EVT_MENU(ID_SAVE_SCREENSHOT, mainFrame::OnSaveScreenshot)
EVT_MENU(ID_BLACK_THEME, mainFrame::OnBlackTheme)
EVT_MENU(ID_TOGGLE_LISSAJOUX, mainFrame::OnToggleLissajoux)
EVT_MENU(ID_TOGGLE_SINE, mainFrame::OnToggleSine)
EVT_MENU(ID_TOGGLE_COSINE, mainFrame::OnToggleCosine)
END_EVENT_TABLE()
...
void mainFrame::OnFit(wxCommandEvent& WXUNUSED(event))
{
	m_plot->Fit();
}
...
void mainFrame::OnAlignXAxis(wxCommandEvent& WXUNUSED(event))
{
...
void mainFrame::OnAlignYAxis(wxCommandEvent& WXUNUSED(event))
{
...
void mainFrame::OnToggleScrollbars(wxCommandEvent& event)
{
	if (event.IsChecked())
...
void mainFrame::OnToggleInfoLayer(wxCommandEvent& event)
{
	if (event.IsChecked())
		nfo->SetVisible(true);
	else
...
void mainFrame::OnBlackTheme(wxCommandEvent& event)
{
	//wxColor black(0,0,0);
...
void mainFrame::OnSaveScreenshot(wxCommandEvent& event)
{
...
void mainFrame::OnToggleLissajoux(wxCommandEvent& event)
{
	m_plot->SetLayerVisible(wxT("Lissajoux"), event.IsChecked());
}

void mainFrame::OnToggleSine(wxCommandEvent& event)
{
	m_plot->SetLayerVisible(wxT("f(x) = SIN(x)"), event.IsChecked());
}

void mainFrame::OnToggleCosine(wxCommandEvent& event)
{
