...
TeleconWxPlot* TeleconChart::getPlot(int index)
{
...
TeleconWxPlot* TeleconChart::getPlotByName(string name)
{
	for (vector<TeleconWxPlot*>::iterator i = m_plots.begin(); i != m_plots.end(); ++i) {
